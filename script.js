...
document.querySelector('#rain-volume').addEventListener('input', function(){
    ...
    if(this.value >= 10 && previousValueOfRainVolume < 10){
        ...
        setTimeout(function(){
            document.querySelector('#day-video').setAttribute('src', 'BDR RAINY DAY - Christmas ver.mp4')
            document.querySelector('#night-video').setAttribute('src', 'BDR RAINY NIGHT - Christmas ver.mp4')
        ...
        setTimeout(function(){
            document.querySelector('#day-video').setAttribute('src', 'BDR Day-Christmas ver 112521 (1).mp4')
            document.querySelector('#night-video').setAttribute('src', 'BDR STARRY NIGHT - Christmas ver.mp4')
